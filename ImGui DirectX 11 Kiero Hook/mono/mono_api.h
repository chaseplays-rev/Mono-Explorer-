...
namespace API {
	inline void Initialize() {
		...
		mono_assembly_foreach =
			reinterpret_cast<t_mono_assembly_foreach>(
		...
		mono_class_get =
			reinterpret_cast<t_mono_class_get>(
				_MonoMemory.GetExport(L"mono_class_get")
				);
		mono_class_get_fields =
			reinterpret_cast<t_mono_class_get_fields>(
				_MonoMemory.GetExport(L"mono_class_get_fields"));

		mono_field_get_type =
			reinterpret_cast<t_mono_field_get_type>(
				_MonoMemory.GetExport(L"mono_field_get_type"));

		mono_type_get_name =
			reinterpret_cast<t_mono_type_get_name>(
				_MonoMemory.GetExport(L"mono_type_get_name"));

		mono_method_get_name =
			reinterpret_cast<t_mono_method_get_name>(
				_MonoMemory.GetExport(L"mono_method_get_name"));

		mono_class_get_properties =
			reinterpret_cast<t_mono_class_get_properties>(
				_MonoMemory.GetExport(L"mono_class_get_properties"));

		mono_property_get_name =
			reinterpret_cast<t_mono_property_get_name>(
				_MonoMemory.GetExport(L"mono_property_get_name"));
