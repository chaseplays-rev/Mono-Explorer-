...
typedef void (*t_mono_assembly_foreach)(
	void (*callback)(MonoAssembly* assembly, void* user_data),
	void* user_data
	);
inline t_mono_assembly_foreach mono_assembly_foreach;


typedef const MonoTableInfo* (*t_mono_image_get_table_info)(
	MonoImage* image,
	int table_id
	);
inline t_mono_image_get_table_info mono_image_get_table_info;


typedef int (*t_mono_table_info_get_rows)(
	const MonoTableInfo* table
	);
inline t_mono_table_info_get_rows mono_table_info_get_rows;


typedef MonoClass* (*t_mono_class_get)(
	MonoImage* image,
	uint32_t token
	);
inline t_mono_class_get mono_class_get;

typedef MonoField* (*t_mono_class_get_fields)(MonoClass* klass, void** iter);
inline t_mono_class_get_fields mono_class_get_fields;

typedef MonoType* (*t_mono_field_get_type)(MonoField* field);
inline t_mono_field_get_type mono_field_get_type;

typedef char* (*t_mono_type_get_name)(MonoType* type);
...
typedef MonoProperty* (*t_mono_class_get_properties)(MonoClass* klass, void** iter);
inline t_mono_class_get_properties mono_class_get_properties;

typedef const char* (*t_mono_property_get_name)(MonoProperty* property);
inline t_mono_property_get_name mono_property_get_name;
